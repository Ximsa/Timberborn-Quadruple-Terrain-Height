...
namespace Timberborn.QuadrupleTerrainHeight
{
    public class QuadrupleTerrainHeightPlugin : IModStarter
    {
        ...
        public void StartMod()
        {
            var factor = 4;
            // terrain height
            var maxEditorTerrainHeight =
                typeof(MapSize).GetField("MaxMapEditorTerrainHeight", BindingFlags.Static | BindingFlags.Public);
            var maxGameTerrainHeight =
                typeof(MapSize).GetField("MaxGameTerrainHeight", BindingFlags.Static | BindingFlags.Public);
            ...
            var brushSize = Type
                .GetType(
                    "Timberborn.BrushesUI.BrushSizePanel, Timberborn.BrushesUI, Version = 0.0.0.0, Culture = neutral, PublicKeyToken = null")
